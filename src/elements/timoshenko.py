...
class TimoshenkoCreator(ElementCreator):
    ...
    def __init__(self, properties):
        """
        The constructor fo the TimoshenkoCreator is a dictionary of
    ...
    def createElement(self, cell, nodes):
        return TimoshenkoElement(cell, nodes, self)


    def getDOFsPerNode(self) -> int:
        """
        Each node of the plane Timoshenko has three dofs: (ux, uy, theta)
        """
        return 3

    def print(self):
        print("Element type: Timoshenko")
...
class TimoshenkoElement(Element):
    ...
    def __init__(self, cell, nodes, eltype):
        ...
        variables that are created and can be accessed later on are:
           theNodes: the two nodes of the Timoshenko
    ...
    def integrateEnergy(self):
        """
        Integrates the total potential energy in the Timoshenko element.
        Returns it value.
        """
        node0 = self.theNodes[0]
        node1 = self.theNodes[1]
    ...
    def result(self, name):
        ...
        on the state of the Timoshenko. It is used by the plotting functions.
        """
        E = self.theType.YoungModulus
